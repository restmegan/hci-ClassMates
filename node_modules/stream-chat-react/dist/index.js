...
var UnMemoizedAttachmentActions = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: 'str-chat__message-attachment-actions' },
        React__default['default'].createElement("div", { className: 'str-chat__message-attachment-actions-form' },
            ...
            actions.map(function (action) { return (React__default['default'].createElement("button", { className: "str-chat__message-attachment-actions-button str-chat__message-attachment-actions-button--" + action.style, "data-testid": "" + action.name, "data-value": action.value, key: id + "-" + action.value, onClick: function (event) {
    ...
    return (React__default['default'].createElement("div", { className: 'str-chat__message-attachment-file--item', "data-testid": 'attachment-file' },
        ...
        React__default['default'].createElement("div", { className: 'str-chat__message-attachment-file--item-text' },
            ...
            attachment.file_size &&
                Number.isFinite(Number(attachment.file_size)) && (React__default['default'].createElement("span", null, prettybytes__default['default'](attachment.file_size))))));
};
...
var channelReducer = function (state, action) {
    ...
    switch (action.type) {
        ...
        case 'updateThreadOnEvent': {
            ...
            if (!state.thread)
                return state;
            return __assign(__assign({}, state), { thread: (message === null || message === void 0 ? void 0 : message.id) === state.thread.id
                    ? channel.state.formatMessage(message)
                    : state.thread, threadMessages: ((_a = state.thread) === null || _a === void 0 ? void 0 : _a.id) ? __assign({}, channel.state.threads)[state.thread.id] || []
                    : [] });
        }
        case 'openThread': {
            var channel = action.channel, message = action.message;
            return __assign(__assign({}, state), { thread: message, threadMessages: message.id
                    ? __assign({}, channel.state.threads)[message.id] || []
                    : [] });
        }
...
var areMessageUIPropsEqual = function (prevProps, nextProps) {
    ...
    if ((prevMessage.id === prevLastReceivedId ||
    ...
    return function (event) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    errorMessage = getErrorNotification &&
...
var useMentionsHandler = function (message, customMentionHandler) {
    ...
    var onMentionsClick = (customMentionHandler === null || customMentionHandler === void 0 ? void 0 : customMentionHandler.onMentionsClick) ||
        channelOnMentionsClick ||
        (function () { return null; });
    var onMentionsHover = (customMentionHandler === null || customMentionHandler === void 0 ? void 0 : customMentionHandler.onMentionsHover) ||
...
var useMentionsUIHandler = function (message, eventHandlers) {
    ...
    return {
        onMentionsClick: (eventHandlers === null || eventHandlers === void 0 ? void 0 : eventHandlers.onMentionsClick) ||
            createEventHandler(onMentionsClick, message),
        onMentionsHover: (eventHandlers === null || eventHandlers === void 0 ? void 0 : eventHandlers.onMentionsHover) ||
...
var usePinHandler = function (message, permissions, notifications) {
    ...
    var canPin = function () {
        var _a;
        if (!(client === null || client === void 0 ? void 0 : client.userID) ||
            !(channel === null || channel === void 0 ? void 0 : channel.state) ||
            !permissions ||
...
var useUserHandler = function (message, eventHandlers) { return ({
    onUserClick: function (event) {
        if (typeof (eventHandlers === null || eventHandlers === void 0 ? void 0 : eventHandlers.onUserClickHandler) !== 'function' ||
            !(message === null || message === void 0 ? void 0 : message.user)) {
            return;
        }
        eventHandlers.onUserClickHandler(event, message.user);
    },
    onUserHover: function (event) {
        if (typeof (eventHandlers === null || eventHandlers === void 0 ? void 0 : eventHandlers.onUserHoverHandler) !== 'function' ||
            !(message === null || message === void 0 ? void 0 : message.user)) {
            return;
        }
...
var useUserRole = function (message) {
    ...
    var isAdmin = ((_a = client === null || client === void 0 ? void 0 : client.user) === null || _a === void 0 ? void 0 : _a.role) === 'admin' ||
        ((_c = (_b = channel === null || channel === void 0 ? void 0 : channel.state) === null || _b === void 0 ? void 0 : _b.membership) === null || _c === void 0 ? void 0 : _c.role) === 'admin';
    ...
    return (React__default['default'].createElement("div", { className: "str-chat__message-actions-box\n        " + (open ? 'str-chat__message-actions-box--open' : '') + "\n        " + (mine ? 'str-chat__message-actions-box--mine' : '') + "\n        " + (reverse ? 'str-chat__message-actions-box--reverse' : '') + "\n      ", "data-testid": 'message-actions-box', ref: checkIfReverse },
        React__default['default'].createElement("ul", { className: 'str-chat__message-actions-list' },
            messageActions.indexOf(MESSAGE_ACTIONS.pin) > -1 &&
                !(message === null || message === void 0 ? void 0 : message.parent_id) && (React__default['default'].createElement("button", { onClick: handlePin },
...
var MessageActions = function (props) {
    ...
    var isMuted = React.useCallback(function () { return isUserMuted(message, mutes); }, [
        message,
        mutes,
    ]);
...
var MessageActionsWrapper = function (props) {
    ...
    var wrapperClass = typeof customWrapperClass === 'string'
        ? customWrapperClass
        : defaultWrapperClass;
        ...
        var noParsingNeeded = markdownLinks &&
            markdownLinks.filter(function (text) {
                ...
                if (!strippedHref || !strippedText)
                    return false;
                return (strippedHref.includes(strippedText) ||
...
var UnMemoizedFixedHeightMessage = function (props) {
    ...
    var renderedText = React.useMemo(function () { return renderText(messageTextToRender, message.mentioned_users); }, [message.mentioned_users, messageTextToRender]);
...
var UnMemoizedReactionSelector = React__default['default'].forwardRef(function (props, ref) {
    ...
    React.useEffect(function () {
        ...
        if (tooltipReactionType) {
            ...
            var container = isMutableRef(ref)
                ? (_c = ref.current) === null || _c === void 0 ? void 0 : _c.getBoundingClientRect() : null;
    ...
    var getLatestUserForReactionType = function (type) {
        var _a;
        return ((_a = latest_reactions === null || latest_reactions === void 0 ? void 0 : latest_reactions.find(function (reaction) { return reaction.type === type && !!reaction.user; })) === null || _a === void 0 ? void 0 : _a.user) || undefined;
    };
    return (React__default['default'].createElement("div", { className: "str-chat__reaction-selector " + (reverse ? 'str-chat__reaction-selector--reverse' : ''), "data-testid": 'reaction-selector', ref: ref },
        ...
        React__default['default'].createElement("ul", { className: 'str-chat__message-reactions-list' }, reactionOptions === null || reactionOptions === void 0 ? void 0 : reactionOptions.map(function (reactionOption) {
            ...
            return (React__default['default'].createElement("li", { className: 'str-chat__message-reactions-list-item', "data-text": reactionOption.id, key: "item-" + reactionOption.id, onClick: function (event) {
...
var UnMemoizedReactionsList = function (props) {
    ...
    var emojiData = React.useMemo(function () { return getStrippedEmojiData(fullEmojiData); }, [
        fullEmojiData,
    ]);
    var reactionOptions = reactionOptionsProp || defaultMinimalEmojis || [];
    ...
    var getOptionForType = function (type) {
...
var UnMemoizedMessageTextComponent = function (props) {
    ...
    var messageTextToRender = ((_a = message.i18n) === null || _a === void 0 ? void 0 : _a[userLanguage + "_text"]) ||
        message.text;
    var messageText = React.useMemo(function () { return renderText$1(messageTextToRender, message.mentioned_users); }, [message.mentioned_users, messageTextToRender]);
    ...
    switch (action.type) {
        ...
        case 'setImageUpload': {
            ...
            if (!imageAlreadyExists && !action.file)
                return state;
            var imageOrder = imageAlreadyExists
                ? state.imageOrder
                : state.imageOrder.concat(action.id);
            var newUploadFields = __assign({}, action);
            delete newUploadFields.type;
            return __assign(__assign({}, state), { imageOrder: imageOrder, imageUploads: __assign(__assign({}, state.imageUploads), (_a = {}, _a[action.id] = __assign(__assign({}, state.imageUploads[action.id]), newUploadFields), _a)), numberOfUploads: imageAlreadyExists
        ...
        case 'setFileUpload': {
            ...
            if (!fileAlreadyExists && !action.file)
                return state;
            var fileOrder = fileAlreadyExists
                ? state.fileOrder
                : state.fileOrder.concat(action.id);
            var newUploadFields = __assign({}, action);
            delete newUploadFields.type;
            return __assign(__assign({}, state), { fileOrder: fileOrder, fileUploads: __assign(__assign({}, state.fileUploads), (_b = {}, _b[action.id] = __assign(__assign({}, state.fileUploads[action.id]), newUploadFields), _b)), numberOfUploads: fileAlreadyExists
                    ? state.numberOfUploads
                    : state.numberOfUploads + 1 });
        }
...
var useMessageInput = function (props) {
    ...
    var insertText = React.useCallback(function (textToInsert) {
        ...
        dispatch({
            getNewText: function (prevText) {
                var updatedText = prevText.slice(0, selectionStart) +
                    textToInsert +
    ...
    var onSelectEmoji = React.useCallback(function (emoji) { return insertText(emoji.native); }, [insertText]);
    // Commands / mentions
    var getCommands = React.useCallback(function () { var _a, _b; return (_b = (_a = channel === null || channel === void 0 ? void 0 : channel.getConfig) === null || _a === void 0 ? void 0 : _a.call(channel)) === null || _b === void 0 ? void 0 : _b.commands; }, [
        channel,
    ]);
    var getUsers = React.useCallback(function () {
        ...
        return __spreadArrays(Object.values(channel.state.members).map(function (_a) {
            ...
            return self.findIndex(function (user) { return (user === null || user === void 0 ? void 0 : user.id) === (_user === null || _user === void 0 ? void 0 : _user.id); }) === index;
        });
    }, [channel]);
    ...
    React.useEffect(function () {
        if (FileReader) {
            var upload = Object.values(imageUploads).find(function (imageUpload) {
                return imageUpload.state === 'uploading' &&
                    !!imageUpload.file &&
...
var SendButton = function (_a) {
    ...
    var t = useTranslationContext().t;
    return (React__default['default'].createElement("button", { className: 'str-chat__send-button', onClick: 
        /**
         * TODO: fix the below at some point because this type casting is wrong
         * and just forced to not have warnings currently with the unknown casting
         */
...
var UnMemoizedChatAutoComplete = function (props) {
    ...
    var getMembersAndWatchers = React.useCallback(function () {
        var memberUsers = members
            ? Object.values(members).map(function (_a) {
                var user = _a.user;
                return user;
            })
            : [];
    ...
    var queryUsers = function (query, onReady) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, client.queryUsers(__assign({ $or: [
                                { id: { $autocomplete: query } },
                                { name: { $autocomplete: query } },
                            ], id: { $ne: client.userID } }, mentionQueryParams.filters), __assign({ id: 1 }, mentionQueryParams.sort), __assign({ limit: 10 }, mentionQueryParams.options))];
                case 2:
                    users = (_a.sent()).users;
                    if (onReady && users.length) {
                        onReady(users);
            ...
            React__default['default'].createElement("div", { className: 'str-chat__input' },
                React__default['default'].createElement("div", { className: 'str-chat__input--textarea-wrapper' },
                    ...
                    React__default['default'].createElement("div", { className: 'str-chat__emojiselect-wrapper' },
                        React__default['default'].createElement(Tooltip, null, messageInput.emojiPickerIsOpen
...
var MessageInputSmall = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: 'str-chat__small-message-input__wrapper' },
        React__default['default'].createElement(reactFileUtils.ImageDropzone, { accept: channelContext.acceptedFiles, disabled: !messageInput.isUploadEnabled || messageInput.maxFilesLeft === 0, handleFiles: messageInput.uploadNewFiles, maxNumberOfFiles: messageInput.maxFilesLeft, multiple: channelContext.multipleUploads },
            React__default['default'].createElement("div", { className: "str-chat__small-message-input " + (SendButton$1
            ...
            React__default['default'].createElement("div", { className: 'str-chat__message-inner', "data-testid": 'message-inner', onClick: message.status === 'failed' && message.errorStatusCode !== 403
                ...
                !message.text && (React__default['default'].createElement(React__default['default'].Fragment, null,
                    ...
                    hasReactions &&
                        ...
                        isReactionEnabled && (React__default['default'].createElement(ReactionsList$1, { onClick: onReactionListClick, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, reactions: message.latest_reactions, reverse: true })),
                    showDetailedReactions && isReactionEnabled && (React__default['default'].createElement(ReactionSelector$1, { detailedView: true, handleReaction: handleReaction, latest_reactions: message.latest_reactions, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, ref: reactionSelectorRef })))),
...
var MessageSimpleStatus = function (_a) {
    ...
    var justReadByMe = readBy &&
        readBy.length === 1 &&
        readBy[0] &&
        client &&
        readBy[0].id === ((_b = client.user) === null || _b === void 0 ? void 0 : _b.id);
...
var MessageWithContext = function (props) {
    ...
    var isAdmin = userRoles.isAdmin, isModerator = userRoles.isModerator, isMyMessage = userRoles.isMyMessage, isOwner = userRoles.isOwner;
    var canEdit = isMyMessage || isModerator || isOwner || isAdmin;
        ...
        React__default['default'].createElement("div", { className: "str-chat__message-livestream str-chat__message-livestream--" + firstGroupStyle + " str-chat__message-livestream--" + message.type + " str-chat__message-livestream--" + message.status + " " + (initialMessage ? 'str-chat__message-livestream--initial-message' : '') + " " + (message.pinned ? 'pinned-message' : ''), "data-testid": 'message-livestream', ref: messageWrapperRef },
            ...
            React__default['default'].createElement("div", { className: 'str-chat__message-livestream-right' },
                React__default['default'].createElement("div", { className: 'str-chat__message-livestream-content' },
                    ...
                    React__default['default'].createElement("div", { className: isOnlyEmojis(message.text)
                            ? 'str-chat__message-livestream-text--is-emoji'
                            : '', "data-testid": 'message-livestream-text', onClick: onMentionsClickMessage, onMouseOver: onMentionsHoverMessage },
                        message.type !== 'error' &&
                            message.status !== 'failed' &&
                            !unsafeHTML &&
                            messageText,
                        ...
                        message.status === 'failed' && (React__default['default'].createElement("p", { onClick: message.errorStatusCode !== 403
                                ? function () { return handleRetry(message); }
                                : undefined },
                            React__default['default'].createElement(ErrorIcon, null),
...
var MessageTeamWithContext = function (props) {
    ...
    var messageText = React.useMemo(function () { return renderText$1(messageTextToRender, messageMentionedUsersItem); }, [messageMentionedUsersItem, messageTextToRender]);
    var firstGroupStyle = groupStyles ? groupStyles[0] : '';
        ...
        React__default['default'].createElement("div", { className: "str-chat__message-team str-chat__message-team--" + firstGroupStyle + " str-chat__message-team--" + message.type + " " + (threadList ? 'thread-list' : '') + " str-chat__message-team--" + message.status + " " + (message.pinned ? 'pinned-message' : ''), "data-testid": 'message-team', ref: messageWrapperRef },
            React__default['default'].createElement("div", { className: 'str-chat__message-team-meta' },
                firstGroupStyle === 'top' ||
                    ...
                    initialMessage ? (React__default['default'].createElement(Avatar$1, { image: (_e = message.user) === null || _e === void 0 ? void 0 : _e.image, name: ((_f = message.user) === null || _f === void 0 ? void 0 : _f.name) || ((_g = message.user) === null || _g === void 0 ? void 0 : _g.id), onClick: onUserClick, onMouseOver: onUserHover, size: 40 })) : (React__default['default'].createElement("div", { "data-testid": 'team-meta-spacer', style: { marginRight: 0, width: 40 } })),
            ...
            React__default['default'].createElement("div", { className: 'str-chat__message-team-group' },
                message &&
                    (firstGroupStyle === 'top' ||
                        firstGroupStyle === 'single' ||
                        initialMessage) && (React__default['default'].createElement("div", { className: 'str-chat__message-team-author', "data-testid": 'message-team-author', onClick: onUserClick },
                    React__default['default'].createElement("strong", null, ((_h = message.user) === null || _h === void 0 ? void 0 : _h.name) || ((_j = message.user) === null || _j === void 0 ? void 0 : _j.id)),
                    message.type === 'error' && (React__default['default'].createElement("div", { className: 'str-chat__message-team-error-header' }, t('Only visible to you'))))),
                React__default['default'].createElement("div", { className: "str-chat__message-team-content str-chat__message-team-content--" + firstGroupStyle + " str-chat__message-team-content--" + (message.text === '' ? 'image' : 'text'), "data-testid": 'message-team-content' },
                    ...
                    message && (React__default['default'].createElement("span", { className: isOnlyEmojis(message.text)
                            ? 'str-chat__message-team-text--is-emoji'
                            : '', "data-testid": 'message-team-message', onClick: onMentionsClickMessage, onMouseOver: onMentionsHoverMessage }, unsafeHTML && message.html ? (React__default['default'].createElement("div", { dangerouslySetInnerHTML: { __html: message.html } })) : (messageText))),
                    message.mml && (React__default['default'].createElement(MML, { actionHandler: handleAction, align: 'left', source: message.mml })),
                    ...
                    ((_k = message.latest_reactions) === null || _k === void 0 ? void 0 : _k.length) !== 0 &&
                        message.text !== '' &&
                    ...
                    message.status === 'failed' && (React__default['default'].createElement("button", { className: 'str-chat__message-team-failed', "data-testid": 'message-team-failed', onClick: message.errorStatusCode !== 403
                            ? function () { return handleRetry(message); }
                            : undefined },
                        React__default['default'].createElement(ErrorIcon, null),
                        message.errorStatusCode !== 403
...
var MessageTeamStatus = function (props) {
    ...
    var justReadByMe = readBy && (client === null || client === void 0 ? void 0 : client.user) &&
        readBy.length === 1 &&
        readBy[0] &&
...
var ChannelInner = function (props) {
    ...
    var _k = useChatContext(), client = _k.client, mutes = _k.mutes, theme = _k.theme;
    var t = useTranslationContext().t;
    ...
    var handleEvent = React.useCallback(function (event) {
        ...
        if (event.type === 'message.new') {
            ...
            if (mainChannelUpdated && ((_d = (_c = event.message) === null || _c === void 0 ? void 0 : _c.user) === null || _d === void 0 ? void 0 : _d.id) !== client.userID) {
                ...
                else if (((_e = channel.getConfig()) === null || _e === void 0 ? void 0 : _e.read_events) &&
    ...
    var addNotification = function (text, type) {
        ...
        var id = uuid.v4();
        setNotifications(function (prevNotifications) { return __spreadArrays(prevNotifications, [
...
var UnMemoizedChatDown = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: 'str-chat__down' },
        ...
        React__default['default'].createElement("div", { className: 'str-chat__down-main' },
            ...
            React__default['default'].createElement("h3", null, text ||
    ...
    React.useEffect(function () {
        var handleEvent = function (event) {
            if (customHandler && typeof customHandler === 'function') {
                ...
                setChannels(function (channels) {
                    return channels.filter(function (channel) { var _a; return channel.cid !== ((_a = event.channel) === null || _a === void 0 ? void 0 : _a.cid); });
                });
            }
        };
...
var UnMemoizedChannelList = function (props) {
    ...
    var _l = useChatContext(), channel = _l.channel, client = _l.client, closeMobileNav = _l.closeMobileNav, _m = _l.navOpen, navOpen = _m === void 0 ? false : _m, setActiveChannel = _l.setActiveChannel, theme = _l.theme;
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement("div", { className: "str-chat str-chat-channel-list " + theme + " " + (navOpen ? 'str-chat-channel-list--open' : ''), ref: channelListRef }, renderList())));
};
/**
...
var useChat = function (_a) {
    ...
    React.useEffect(function () {
        var streami18n = i18nInstance instanceof Streami18n
            ? i18nInstance
...
var Chat = function (props) {
    var children = props.children, client = props.client, i18nInstance = props.i18nInstance, _a = props.initialNavOpen, initialNavOpen = _a === void 0 ? true : _a, _b = props.theme, theme = _b === void 0 ? 'messaging light' : _b;
    var _c = useChat({ client: client, i18nInstance: i18nInstance, initialNavOpen: initialNavOpen }), channel = _c.channel, closeMobileNav = _c.closeMobileNav, mutes = _c.mutes, navOpen = _c.navOpen, openMobileNav = _c.openMobileNav, setActiveChannel = _c.setActiveChannel, translators = _c.translators;
    if (!translators.t)
        return null;
...
var UnMemoizedDateSeparator = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: 'str-chat__date-separator' },
        ...
        React__default['default'].createElement("div", { className: 'str-chat__date-separator-date' }, unread ? t('New') : formattedDate),
...
var UnMemoizedEventComponent = function (props) {
    ...
    var dateFormatter = function (date, format) {
        ...
        var formattedDate = isDayOrMoment(parsedDate)
    ...
    if (type === 'channel.event' &&
        ...
        var sentence = name_1 + " " + (event.type === 'member.added'
            ? 'has joined the chat'
...
var calculateOffset = function (element, scrollTop) {
    ...
    return (calculateTopPosition(element) +
...
var InfiniteScroll = function (props) {
    ...
    React.useEffect(function () {
        var _a;
        var scrollElement = useWindow
            ? window
            : (_a = scrollComponent.current) === null || _a === void 0 ? void 0 : _a.parentNode;
...
var insertDates = function (messages, lastRead, userID, hideDeletedMessages, disableDateSeparator) {
    var _a, _b;
    var unread = false;
    ...
    for (var i = 0, l = messages.length; i < l; i += 1) {
        ...
        if (!disableDateSeparator &&
            (i === 0 ||
                ...
                (hideDeletedMessages &&
                    ((_a = messages[i - 1]) === null || _a === void 0 ? void 0 : _a.type) === 'deleted' &&
                    lastDateSeparator !== messageDate)) &&
            ((_b = newMessages === null || newMessages === void 0 ? void 0 : newMessages[newMessages.length - 1]) === null || _b === void 0 ? void 0 : _b.type) !== 'message.date' // do not show two date separators in a row
        ) {
            lastDateSeparator = messageDate;
            newMessages.push(
            //@ts-expect-error
...
var UnMemoizedMessageListInner = function (props) {
    ...
    var lastReceivedId = React.useMemo(function () { return getLastReceived(enrichedMessages); }, [
        enrichedMessages,
    ]);
...
var UnMemoizedTypingIndicator = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: "str-chat__typing-indicator " + ((threadList && typingInThread) ||
...
var MessageListWithContext = /** @class */ (function (_super) {
    ...
    function MessageListWithContext(props) {
        ...
        _this.userScrolledUp = function () {
            return (_this.scrollOffset || 0) >
                _this.props.scrolledUpThreshold;
        };
...
var VirtualizedMessageListWithContext = function (props) {
    var channel = props.channel, client = props.client, customMessageRenderer = props.customMessageRenderer, _a = props.disableDateSeparator, disableDateSeparator = _a === void 0 ? true : _a, _b = props.DateSeparator, DateSeparator$1 = _b === void 0 ? DateSeparator : _b, _c = props.EmptyStateIndicator, EmptyStateIndicator$1 = _c === void 0 ? EmptyStateIndicator : _c, hasMore = props.hasMore, _d = props.LoadingIndicator, LoadingIndicator$1 = _d === void 0 ? LoadingIndicator : _d, loadMore = props.loadMore, loadingMore = props.loadingMore, _e = props.Message, Message = _e === void 0 ? FixedHeightMessage : _e, _f = props.MessageDeleted, MessageDeleted$1 = _f === void 0 ? MessageDeleted : _f, _g = props.messageLimit, messageLimit = _g === void 0 ? 100 : _g, messages = props.messages, _h = props.MessageSystem, MessageSystem = _h === void 0 ? EventComponent : _h, _j = props.overscan, overscan = _j === void 0 ? 0 : _j, 
    // TODO: refactor to scrollSeekPlaceHolderConfiguration and components.ScrollSeekPlaceholder, like the Virtuoso Component
    scrollSeekPlaceHolder = props.scrollSeekPlaceHolder, _k = props.shouldGroupByUser, shouldGroupByUser = _k === void 0 ? false : _k, _l = props.stickToBottomScrollBehavior, stickToBottomScrollBehavior = _l === void 0 ? 'smooth' : _l, _m = props.TypingIndicator, TypingIndicator = _m === void 0 ? null : _m;
    var userID = client.userID;
    var lastRead = React.useMemo(function () { var _a; return (_a = channel.lastRead) === null || _a === void 0 ? void 0 : _a.call(channel); }, [channel]);
    ...
    var _o = useNewMessageNotification(processedMessages, client.userID), atBottom = _o.atBottom, newMessagesNotification = _o.newMessagesNotification, setNewMessagesNotification = _o.setNewMessagesNotification;
    ...
    return (React__default['default'].createElement("div", { className: 'str-chat__virtual-list' },
        React__default['default'].createElement(reactVirtuoso.Virtuoso, __assign({ atBottomStateChange: function (isAtBottom) {
            ...
            }, initialTopMostItemIndex: processedMessages && processedMessages.length > 0
                ? processedMessages.length - 1
                : 0, itemContent: function (i) { return messageRenderer(processedMessages, i); }, overscan: overscan, ref: virtuoso, startReached: function () {
                if (hasMore && loadMore) {
                    loadMore(messageLimit);
                }
            }, style: { overflowX: 'hidden' }, totalCount: processedMessages.length }, (scrollSeekPlaceHolder
