...
import React, { useState, useEffect, useCallback, useRef, useContext, useMemo, useReducer, useImperativeHandle, useLayoutEffect, PureComponent } from 'react';
...
var EmojiContext = /*#__PURE__*/React.createContext(
...
function withEmojiContext(OriginalComponent) {
  ...
  var ContextAwareComponent = function ContextComponent(props) {
    return /*#__PURE__*/React.createElement(EmojiContext.Consumer, null, function (context) {
      return /*#__PURE__*/React.createElement(OriginalComponent, _extends({}, context, props));
    });
  };
...
var CustomChat = function CustomChat(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ChatContext.Provider, {
    ...
    value: translators
  }, /*#__PURE__*/React.createElement(EmojiContext.Provider, {
    value: emojiConfig
  }, children)));
};
...
var ChatAutoComplete = function ChatAutoComplete(props) {
  ...
  var _useContext2 = useContext(EmojiContext),
...
var MessageInputLarge = function MessageInputLarge(props) {
  ...
  }, /*#__PURE__*/React.createElement(FileUploadIcon$1, null))))), SendButton$1 && /*#__PURE__*/React.createElement(SendButton$1, {
...
var MessageInputSimple = function MessageInputSimple(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "str-chat__input-flat-emojiselect",
    onClick: messageInput.openEmojiPicker
  }, /*#__PURE__*/React.createElement(EmojiIcon, null)))), SendButton$1 && /*#__PURE__*/React.createElement(SendButton$1, {
    sendMessage: messageInput.handleSubmit
  })));
};
...
var ReactionSelectorWithRef = function ReactionSelectorWithRef(_ref, ref) {
  ...
  var _useContext = useContext(EmojiContext),
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }))), Emoji && /*#__PURE__*/React.createElement(Emoji // @ts-ignore because emoji-mart types don't support specifying
...
var FixedHeightMessage$1 = /*#__PURE__*/React.memo(FixedHeightMessage);
    ...
    case 'copyMessagesFromChannel':
      {
        ...
        return _objectSpread$7(_objectSpread$7({}, state), {}, {
          ...
          threadMessages: parentId ? _channel2.state.threads[parentId] || Immutable([]) : state.threadMessages
        });
      }
    ...
    case 'updateThreadOnEvent':
      {
        ...
        return _objectSpread$7(_objectSpread$7({}, state), {}, {
          threadMessages: (_state$thread = state.thread) !== null && _state$thread !== void 0 && _state$thread.id ? _channel3.state.threads[state.thread.id] || Immutable([]) : Immutable([]),
    ...
    case 'openThread':
      {
        ...
        return _objectSpread$7(_objectSpread$7({}, state), {}, {
          thread: _message2,
          threadMessages: _message2.id ? _channel4.state.threads[_message2.id] || Immutable([]) : Immutable([])
        });
      }
...
var ChannelInner = function ChannelInner(_ref2) {
  ...
  var _ref2$Attachment = _ref2.Attachment,
      ...
      props = _objectWithoutProperties(_ref2, ["Attachment", "doMarkReadRequest", "LoadingErrorIndicator", "LoadingIndicator", "Message"]);
  ...
  var online = useRef(true); // eslint-disable-next-line react-hooks/exhaustive-deps
...
var VirtualizedMessageList = function VirtualizedMessageList(_ref) {
  ...
  var messageRenderer = useCallback(function (messageList, i) {
    ...
    if (message.type === 'channel.event' || message.type === 'system') return /*#__PURE__*/React.createElement(MessageSystem, {
      message: message
    });
  ...
  }, /*#__PURE__*/React.createElement(Virtuoso // @ts-ignore
  , {
    ref: virtuoso,
